...
namespace Hl7.Fhir.Specification.Source
{
    ...
    public static class StructureDefinitionSummaryProperties
    {
        ...
        public static readonly string ContextInvariantKey = "StructureDefinition.contextInvariant";
        ...
        public static bool Harvest(IElementNavigator nav, ArtifactSummaryPropertyBag properties)
        {
            if (IsStructureDefinitionSummary(properties))
            {
                ...
                if (ConformanceSummaryProperties.Harvest(nav, properties))
                {
                    ...
                    // [WMR 20180919] NEW: context & contextInvariant
                    nav.HarvestValues(properties, ContextKey, "context");
                    nav.HarvestValues(properties, ContextInvariantKey, "contextInvariant");
        ...
        /// <summary>Get the <c>StructureDefinition.contextInvariant</c> property value from the specified artifact summary property bag, if available.</summary>
        /// <remarks>Only applies to summaries of <see cref="StructureDefinition"/> resources.</remarks>
        public static string[] GetStructureDefinitionContextInvariant(this IArtifactSummaryPropertyBag properties)
            => properties.GetValueOrDefault<string[]>(ContextInvariantKey);
